...
const positiveNumbers = randomNumbers.filter(n => n >= 0);    //istraukiam tik teigiamus skaicius
console.log(positiveNumbers);

const negativeNumbers = randomNumbers.filter(n => n < 0);    //tik neigiamus
console.log(negativeNumbers);

const integerNumbers = randomNumbers.filter(n => n % 1 === 0);  //tik sveikuosius skaicius
console.log(integerNumbers);

const decimalNumbers = randomNumbers.filter(n => n % 1 !== 0);   //tik su liekana 
...
// ne neigiami sveikieji skaiciai (kalba eina apie 0)
const tss = randomData                      //15 (reiksmes is viso - tiek kartu filteris praeis pro duomenis)
    .filter(n => Number.isInteger(n))       //6 (po antro filterio parasymo, filteris turejo pereiti dar 6 reiksmes, kad pasiekti galutini rezultata
    .filter(n => n >= 0);
...
const du = [7, 5];
const duSorted = du[0] < du[1] ? [...du] : [du[1], du[0]];    //greiciausias sortinimo budas
console.log(duSorted);

console.clear();

//pazymiu vidurki skaiciuojam
...
///jei norime susortinti vardus pagal abecele
...
////PASIPRAKTIKUOTI susigalvojant kitus duomenis 